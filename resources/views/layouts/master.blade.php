...
@yield('top')
    ...
    <style>
        .main-header {
            background:rgb(63, 92, 209)!important;
        ...
        .main-header .navbar .user-menu .dropdown-menu .btn-danger {
            background: #e53935;
            border: none;
        }
    </style>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>Ryo</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">
                <i class="fa fa-desktop" style="margin-left:8px; margin-right:8px;"></i>
                Ryoshka Shop
            </span> 
        </a>
...
@include('layouts.sidebar')
    ...
    <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
            Developed by Ryoshka
        </div>
        <!-- Default to the left -->
        <?php $date = date('Y')?>
        <strong>&copy; {{$date}} - Ryoshka Inventory Management System </strong>
    </footer>
