...
@section('content')
    <div class="box">
        ...
        <div class="box-header">
            <a onclick="addForm()" class="btn btn-success" ><i class="fa fa-plus"></i> Add New Sale</a>
            <a href="{{ route('exportPDF.salesAll') }}" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Export PDF</a>
        </div>
