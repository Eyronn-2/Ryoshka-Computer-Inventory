    ...
    <div class="categories-card">
        <div class="categories-header">
            ...
            <div class="categories-actions">
                <a onclick="addForm()" class="btn btn-add"><i class="fa fa-plus"></i> Add New Category</a>
                <a href="{{ route('exportPDF.categoriesAll') }}" class="btn btn-export"><i class="fa fa-file-pdf-o"></i> Export PDF</a>
                <a onclick="showArchived()" class="btn btn-archive"><i class="fa fa-archive"></i> Archived Categories</a>
            </div>
        </div>
        <div class="box-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">Archived Categories</h3>
                </div>
                <div class="modal-body">
                    <table id="archived-categories-table" class="table table-bordered table-hover table-striped">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
...
@section('bot')
    ...
    <script type="text/javascript">
        ...
        function showArchived() {
            ...
            if (!archivedTable) {
                archivedTable = $('#archived-categories-table').DataTable({
                    processing: true,
                    serverSide: true,
                    destroy: true,
                    ajax: "{{ url('api/archived-categories') }}",
                    columns: [
                        {data: 'id', name: 'id'},
                        {data: 'name', name: 'name'},
                        {data: 'action', name: 'action', orderable: false, searchable: false}
        ...
        function archiveData(id){
            ...
            swal({
                title: 'Are you sure?',
                text: "You can unarchive this category later!",
                type: 'warning',
        ...
        function unarchiveData(id){
            ...
            swal({
                ...
                $.ajax({
                    url : "{{ url('categories/unarchive') }}/" + id,
                    type : "POST",
